module github.com/winebarrel/datadog-api-client-go/tests

go 1.14

require (
	github.com/winebarrel/datadog-api-client-go v1.0.0-beta.22
...
replace github.com/winebarrel/datadog-api-client-go => ../
