...
type ApiGetIncidentTeamOptionalParameters struct {
	Include *IncidentRelatedObject
}

func NewApiGetIncidentTeamOptionalParameters() *ApiGetIncidentTeamOptionalParameters {
	this := ApiGetIncidentTeamOptionalParameters{}
	return &this
}
func (r *ApiGetIncidentTeamOptionalParameters) WithInclude(include IncidentRelatedObject) *ApiGetIncidentTeamOptionalParameters {
	r.Include = &include
	return r
}
...
*/
func (a *IncidentTeamsApiService) GetIncidentTeam(ctx _context.Context, teamId string, o ...ApiGetIncidentTeamOptionalParameters) (IncidentTeamResponse, *_nethttp.Response, error) {
...
type ApiListIncidentTeamsOptionalParameters struct {
	Include    *IncidentRelatedObject
	PageSize   *int64
	PageOffset *int64
	Filter     *string
...
func NewApiListIncidentTeamsOptionalParameters() *ApiListIncidentTeamsOptionalParameters {
	this := ApiListIncidentTeamsOptionalParameters{}
	return &this
}
func (r *ApiListIncidentTeamsOptionalParameters) WithInclude(include IncidentRelatedObject) *ApiListIncidentTeamsOptionalParameters {
	r.Include = &include
	return r
}
func (r *ApiListIncidentTeamsOptionalParameters) WithPageSize(pageSize int64) *ApiListIncidentTeamsOptionalParameters {
	r.PageSize = &pageSize
	return r
}
func (r *ApiListIncidentTeamsOptionalParameters) WithPageOffset(pageOffset int64) *ApiListIncidentTeamsOptionalParameters {
	r.PageOffset = &pageOffset
	return r
}
func (r *ApiListIncidentTeamsOptionalParameters) WithFilter(filter string) *ApiListIncidentTeamsOptionalParameters {
	r.Filter = &filter
	return r
}
 ...
 */
func (a *IncidentTeamsApiService) ListIncidentTeams(ctx _context.Context, o ...ApiListIncidentTeamsOptionalParameters) (IncidentTeamsResponse, *_nethttp.Response, error) {
