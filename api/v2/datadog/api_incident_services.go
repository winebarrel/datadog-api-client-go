...
type ApiGetIncidentServiceOptionalParameters struct {
	Include *IncidentRelatedObject
}

func NewApiGetIncidentServiceOptionalParameters() *ApiGetIncidentServiceOptionalParameters {
	this := ApiGetIncidentServiceOptionalParameters{}
	return &this
}
func (r *ApiGetIncidentServiceOptionalParameters) WithInclude(include IncidentRelatedObject) *ApiGetIncidentServiceOptionalParameters {
	r.Include = &include
	return r
}
...
*/
func (a *IncidentServicesApiService) GetIncidentService(ctx _context.Context, serviceId string, o ...ApiGetIncidentServiceOptionalParameters) (IncidentServiceResponse, *_nethttp.Response, error) {
...
type ApiListIncidentServicesOptionalParameters struct {
	Include    *IncidentRelatedObject
	PageSize   *int64
	PageOffset *int64
	Filter     *string
...
func NewApiListIncidentServicesOptionalParameters() *ApiListIncidentServicesOptionalParameters {
	this := ApiListIncidentServicesOptionalParameters{}
	return &this
}
func (r *ApiListIncidentServicesOptionalParameters) WithInclude(include IncidentRelatedObject) *ApiListIncidentServicesOptionalParameters {
	r.Include = &include
	return r
}
func (r *ApiListIncidentServicesOptionalParameters) WithPageSize(pageSize int64) *ApiListIncidentServicesOptionalParameters {
	r.PageSize = &pageSize
	return r
}
func (r *ApiListIncidentServicesOptionalParameters) WithPageOffset(pageOffset int64) *ApiListIncidentServicesOptionalParameters {
	r.PageOffset = &pageOffset
	return r
}
func (r *ApiListIncidentServicesOptionalParameters) WithFilter(filter string) *ApiListIncidentServicesOptionalParameters {
	r.Filter = &filter
	return r
}
 ...
 */
func (a *IncidentServicesApiService) ListIncidentServices(ctx _context.Context, o ...ApiListIncidentServicesOptionalParameters) (IncidentServicesResponse, *_nethttp.Response, error) {
