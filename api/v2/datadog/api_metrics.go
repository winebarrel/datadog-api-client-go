...
type ApiListTagConfigurationsOptionalParameters struct {
	FilterConfigured         *bool
	FilterTagsConfigured     *string
	FilterMetricType         *MetricTagConfigurationMetricTypes
	FilterIncludePercentiles *bool
...
func NewApiListTagConfigurationsOptionalParameters() *ApiListTagConfigurationsOptionalParameters {
	this := ApiListTagConfigurationsOptionalParameters{}
	return &this
}
func (r *ApiListTagConfigurationsOptionalParameters) WithFilterConfigured(filterConfigured bool) *ApiListTagConfigurationsOptionalParameters {
	r.FilterConfigured = &filterConfigured
	return r
}
func (r *ApiListTagConfigurationsOptionalParameters) WithFilterTagsConfigured(filterTagsConfigured string) *ApiListTagConfigurationsOptionalParameters {
	r.FilterTagsConfigured = &filterTagsConfigured
	return r
}
func (r *ApiListTagConfigurationsOptionalParameters) WithFilterMetricType(filterMetricType MetricTagConfigurationMetricTypes) *ApiListTagConfigurationsOptionalParameters {
	r.FilterMetricType = &filterMetricType
	return r
}
func (r *ApiListTagConfigurationsOptionalParameters) WithFilterIncludePercentiles(filterIncludePercentiles bool) *ApiListTagConfigurationsOptionalParameters {
	r.FilterIncludePercentiles = &filterIncludePercentiles
	return r
}
func (r *ApiListTagConfigurationsOptionalParameters) WithFilterTags(filterTags string) *ApiListTagConfigurationsOptionalParameters {
	r.FilterTags = &filterTags
	return r
}
func (r *ApiListTagConfigurationsOptionalParameters) WithWindowSeconds(windowSeconds int64) *ApiListTagConfigurationsOptionalParameters {
...
*/
func (a *MetricsApiService) ListTagConfigurations(ctx _context.Context, o ...ApiListTagConfigurationsOptionalParameters) (MetricsAndMetricTagConfigurationsResponse, *_nethttp.Response, error) {
