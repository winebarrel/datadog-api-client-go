...
func NewConfiguration() *Configuration {
	cfg := &Configuration{
		...
		OperationServers: map[string]ServerConfigurations{},
		unstableOperations: map[string]bool{
			"AddServiceToIncident":            false,
			"AddTeamToIncident":               false,
			"CreateIncident":                  false,
			"CreateIncidentPostmortem":        false,
			"CreateIncidentSelection":         false,
			"CreateIncidentTodo":              false,
			"DeleteIncident":                  false,
			"DeleteIncidentPostmortem":        false,
			"DeleteIncidentSelection":         false,
			"DeleteIncidentTodo":              false,
			"GetIncident":                     false,
			"GetIncidentPostmortem":           false,
			"GetIncidentPostmortems":          false,
			"GetIncidentSelections":           false,
			"GetIncidentTodo":                 false,
			"GetIncidentTodos":                false,
			"GetIncidents":                    false,
			"GetServicesForIncident":          false,
			"GetTeamsForIncident":             false,
			"IncidentsSummary":                false,
			"PatchIncident":                   false,
			"PatchIncidentPostmortem":         false,
			"PatchIncidentSelection":          false,
			"PatchIncidentTodo":               false,
			"RemoveServiceFromIncident":       false,
			"RemoveTeamFromIncident":          false,
			"SearchIncidents":                 false,
			"CreateIncidentConfigField":       false,
			"CreateIncidentConfigFieldChoice": false,
			"DeleteIncidentConfigField":       false,
			"DeleteIncidentConfigFieldChoice": false,
			"GetIncidentConfigField":          false,
			"GetIncidentConfigFieldChoice":    false,
			"GetIncidentConfigFieldChoices":   false,
			"GetIncidentConfigFields":         false,
			"PatchIncidentConfigField":        false,
			"PatchIncidentConfigFieldChoice":  false,
			"CreateService":                   false,
			"DeleteService":                   false,
			"GetService":                      false,
			"GetServices":                     false,
