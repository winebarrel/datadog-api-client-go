...
type ApiGetIncidentOptionalParameters struct {
	Include *[]IncidentRelatedObject
}

func NewApiGetIncidentOptionalParameters() *ApiGetIncidentOptionalParameters {
	this := ApiGetIncidentOptionalParameters{}
	return &this
}
func (r *ApiGetIncidentOptionalParameters) WithInclude(include []IncidentRelatedObject) *ApiGetIncidentOptionalParameters {
	r.Include = &include
	return r
}
 ...
 */
func (a *IncidentsApiService) GetIncident(ctx _context.Context, incidentId string, o ...ApiGetIncidentOptionalParameters) (IncidentResponse, *_nethttp.Response, error) {
...
type ApiListIncidentsOptionalParameters struct {
	Include    *[]IncidentRelatedObject
	PageSize   *int64
	PageOffset *int64
}

func NewApiListIncidentsOptionalParameters() *ApiListIncidentsOptionalParameters {
	this := ApiListIncidentsOptionalParameters{}
	return &this
}
func (r *ApiListIncidentsOptionalParameters) WithInclude(include []IncidentRelatedObject) *ApiListIncidentsOptionalParameters {
	r.Include = &include
	return r
}
func (r *ApiListIncidentsOptionalParameters) WithPageSize(pageSize int64) *ApiListIncidentsOptionalParameters {
	r.PageSize = &pageSize
	return r
}
func (r *ApiListIncidentsOptionalParameters) WithPageOffset(pageOffset int64) *ApiListIncidentsOptionalParameters {
 ...
 */
func (a *IncidentsApiService) ListIncidents(ctx _context.Context, o ...ApiListIncidentsOptionalParameters) (IncidentsResponse, *_nethttp.Response, error) {
