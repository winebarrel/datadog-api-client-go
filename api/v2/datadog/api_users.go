...
type ApiListUsersOptionalParameters struct {
	PageSize     *int64
	PageNumber   *int64
	Sort         *string
	SortDir      *QuerySortOrder
...
func NewApiListUsersOptionalParameters() *ApiListUsersOptionalParameters {
	this := ApiListUsersOptionalParameters{}
	return &this
}
func (r *ApiListUsersOptionalParameters) WithPageSize(pageSize int64) *ApiListUsersOptionalParameters {
	r.PageSize = &pageSize
	return r
}
func (r *ApiListUsersOptionalParameters) WithPageNumber(pageNumber int64) *ApiListUsersOptionalParameters {
	r.PageNumber = &pageNumber
	return r
}
func (r *ApiListUsersOptionalParameters) WithSort(sort string) *ApiListUsersOptionalParameters {
	r.Sort = &sort
	return r
}
func (r *ApiListUsersOptionalParameters) WithSortDir(sortDir QuerySortOrder) *ApiListUsersOptionalParameters {
	r.SortDir = &sortDir
	return r
}
func (r *ApiListUsersOptionalParameters) WithFilter(filter string) *ApiListUsersOptionalParameters {
	r.Filter = &filter
	return r
}
func (r *ApiListUsersOptionalParameters) WithFilterStatus(filterStatus string) *ApiListUsersOptionalParameters {
...
*/
func (a *UsersApiService) ListUsers(ctx _context.Context, o ...ApiListUsersOptionalParameters) (UsersResponse, *_nethttp.Response, error) {
