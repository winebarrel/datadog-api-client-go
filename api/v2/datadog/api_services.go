...
func (r apiCreateServiceRequest) Body(body ServicePayload) apiCreateServiceRequest {
	r.body = &body
	return r
}
...
*/
func (r apiCreateServiceRequest) Execute() (ServicePayload, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ServicePayload
	)
...
func (r apiDeleteServiceRequest) Execute() (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/services/{service_id}"
...
Execute executes the request
 @return ServicePayload
*/
func (r apiGetServiceRequest) Execute() (ServicePayload, *_nethttp.Response, error) {
	var (
...
func (r apiGetServicesRequest) WithUsers(withUsers bool) apiGetServicesRequest {
	r.withUsers = &withUsers
	return r
}

func (r apiGetServicesRequest) PageLimit(pageLimit int64) apiGetServicesRequest {
...
Get all services for a given organization. If the `with_users` query parameter is not set, the included attribute and associated user relationships will not be returned.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
*/
func (r apiGetServicesRequest) Execute() (ServiceListPayload, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r apiPatchServiceRequest) Body(body ServicePayload) apiPatchServiceRequest {
	r.body = &body
	return r
}

/*
PatchService Update an existing service
...
*/
func (a *ServicesApiService) PatchService(ctx _context.Context, serviceId string) apiPatchServiceRequest {
	return apiPatchServiceRequest{
		apiService: a,
		ctx:        ctx,
		serviceId:  serviceId,
...
Execute executes the request
 @return ServicePayload
*/
func (r apiPatchServiceRequest) Execute() (ServicePayload, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ServicesApiService.PatchService")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
