...
type ApiListRoleUsersOptionalParameters struct {
	PageSize   *int64
	PageNumber *int64
	Sort       *string
	Filter     *string
...
func NewApiListRoleUsersOptionalParameters() *ApiListRoleUsersOptionalParameters {
	this := ApiListRoleUsersOptionalParameters{}
	return &this
}
func (r *ApiListRoleUsersOptionalParameters) WithPageSize(pageSize int64) *ApiListRoleUsersOptionalParameters {
	r.PageSize = &pageSize
	return r
}
func (r *ApiListRoleUsersOptionalParameters) WithPageNumber(pageNumber int64) *ApiListRoleUsersOptionalParameters {
	r.PageNumber = &pageNumber
	return r
}
func (r *ApiListRoleUsersOptionalParameters) WithSort(sort string) *ApiListRoleUsersOptionalParameters {
	r.Sort = &sort
	return r
}
func (r *ApiListRoleUsersOptionalParameters) WithFilter(filter string) *ApiListRoleUsersOptionalParameters {
	r.Filter = &filter
	return r
}
 ...
 */
func (a *RolesApiService) ListRoleUsers(ctx _context.Context, roleId string, o ...ApiListRoleUsersOptionalParameters) (UsersResponse, *_nethttp.Response, error) {
...
type ApiListRolesOptionalParameters struct {
	PageSize   *int64
	PageNumber *int64
	Sort       *RolesSort
	Filter     *string
...
func NewApiListRolesOptionalParameters() *ApiListRolesOptionalParameters {
	this := ApiListRolesOptionalParameters{}
	return &this
}
func (r *ApiListRolesOptionalParameters) WithPageSize(pageSize int64) *ApiListRolesOptionalParameters {
	r.PageSize = &pageSize
	return r
}
func (r *ApiListRolesOptionalParameters) WithPageNumber(pageNumber int64) *ApiListRolesOptionalParameters {
	r.PageNumber = &pageNumber
	return r
}
func (r *ApiListRolesOptionalParameters) WithSort(sort RolesSort) *ApiListRolesOptionalParameters {
	r.Sort = &sort
	return r
}
func (r *ApiListRolesOptionalParameters) WithFilter(filter string) *ApiListRolesOptionalParameters {
	r.Filter = &filter
	return r
}
 ...
 */
func (a *RolesApiService) ListRoles(ctx _context.Context, o ...ApiListRolesOptionalParameters) (RolesResponse, *_nethttp.Response, error) {
