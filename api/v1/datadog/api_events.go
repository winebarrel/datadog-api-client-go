...
type ApiListEventsOptionalParameters struct {
	Priority     *EventPriority
	Sources      *string
	Tags         *string
	Unaggregated *bool
...
func NewApiListEventsOptionalParameters() *ApiListEventsOptionalParameters {
	this := ApiListEventsOptionalParameters{}
	return &this
}
func (r *ApiListEventsOptionalParameters) WithPriority(priority EventPriority) *ApiListEventsOptionalParameters {
	r.Priority = &priority
	return r
}
func (r *ApiListEventsOptionalParameters) WithSources(sources string) *ApiListEventsOptionalParameters {
	r.Sources = &sources
	return r
}
func (r *ApiListEventsOptionalParameters) WithTags(tags string) *ApiListEventsOptionalParameters {
	r.Tags = &tags
	return r
}
func (r *ApiListEventsOptionalParameters) WithUnaggregated(unaggregated bool) *ApiListEventsOptionalParameters {
...
*/
func (a *EventsApiService) ListEvents(ctx _context.Context, start int64, end int64, o ...ApiListEventsOptionalParameters) (EventListResponse, *_nethttp.Response, error) {
