...
type ApiSubmitLogOptionalParameters struct {
	ContentEncoding *ContentEncoding
	Ddtags          *string
}

func NewApiSubmitLogOptionalParameters() *ApiSubmitLogOptionalParameters {
	this := ApiSubmitLogOptionalParameters{}
	return &this
}
func (r *ApiSubmitLogOptionalParameters) WithContentEncoding(contentEncoding ContentEncoding) *ApiSubmitLogOptionalParameters {
	r.ContentEncoding = &contentEncoding
	return r
}
func (r *ApiSubmitLogOptionalParameters) WithDdtags(ddtags string) *ApiSubmitLogOptionalParameters {
	r.Ddtags = &ddtags
	return r
}
...
*/
func (a *LogsApiService) SubmitLog(ctx _context.Context, body []HTTPLogItem, o ...ApiSubmitLogOptionalParameters) (interface{}, *_nethttp.Response, error) {
