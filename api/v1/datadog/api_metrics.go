...
type ApiListActiveMetricsOptionalParameters struct {
	Host      *string
	TagFilter *string
}

func NewApiListActiveMetricsOptionalParameters() *ApiListActiveMetricsOptionalParameters {
	this := ApiListActiveMetricsOptionalParameters{}
	return &this
}
func (r *ApiListActiveMetricsOptionalParameters) WithHost(host string) *ApiListActiveMetricsOptionalParameters {
	r.Host = &host
	return r
}
func (r *ApiListActiveMetricsOptionalParameters) WithTagFilter(tagFilter string) *ApiListActiveMetricsOptionalParameters {
 ...
 */
func (a *MetricsApiService) ListActiveMetrics(ctx _context.Context, from int64, o ...ApiListActiveMetricsOptionalParameters) (MetricsListResponse, *_nethttp.Response, error) {
