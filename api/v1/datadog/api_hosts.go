...
type ApiGetHostTotalsOptionalParameters struct {
	From *int64
}

func NewApiGetHostTotalsOptionalParameters() *ApiGetHostTotalsOptionalParameters {
	this := ApiGetHostTotalsOptionalParameters{}
	return &this
}
func (r *ApiGetHostTotalsOptionalParameters) WithFrom(from int64) *ApiGetHostTotalsOptionalParameters {
	r.From = &from
	return r
}
...
*/
func (a *HostsApiService) GetHostTotals(ctx _context.Context, o ...ApiGetHostTotalsOptionalParameters) (HostTotals, *_nethttp.Response, error) {
...
type ApiListHostsOptionalParameters struct {
	Filter                *string
	SortField             *string
	SortDir               *string
	Start                 *int64
...
func NewApiListHostsOptionalParameters() *ApiListHostsOptionalParameters {
	this := ApiListHostsOptionalParameters{}
	return &this
}
func (r *ApiListHostsOptionalParameters) WithFilter(filter string) *ApiListHostsOptionalParameters {
	r.Filter = &filter
	return r
}
func (r *ApiListHostsOptionalParameters) WithSortField(sortField string) *ApiListHostsOptionalParameters {
	r.SortField = &sortField
	return r
}
func (r *ApiListHostsOptionalParameters) WithSortDir(sortDir string) *ApiListHostsOptionalParameters {
	r.SortDir = &sortDir
	return r
}
func (r *ApiListHostsOptionalParameters) WithStart(start int64) *ApiListHostsOptionalParameters {
	r.Start = &start
	return r
}
func (r *ApiListHostsOptionalParameters) WithCount(count int64) *ApiListHostsOptionalParameters {
	r.Count = &count
	return r
}
func (r *ApiListHostsOptionalParameters) WithFrom(from int64) *ApiListHostsOptionalParameters {
	r.From = &from
	return r
}
func (r *ApiListHostsOptionalParameters) WithIncludeMutedHostsData(includeMutedHostsData bool) *ApiListHostsOptionalParameters {
	r.IncludeMutedHostsData = &includeMutedHostsData
	return r
}
func (r *ApiListHostsOptionalParameters) WithIncludeHostsMetadata(includeHostsMetadata bool) *ApiListHostsOptionalParameters {
...
*/
func (a *HostsApiService) ListHosts(ctx _context.Context, o ...ApiListHostsOptionalParameters) (HostListResponse, *_nethttp.Response, error) {
