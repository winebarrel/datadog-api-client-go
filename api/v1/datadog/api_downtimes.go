...
type ApiListDowntimesOptionalParameters struct {
	CurrentOnly *bool
}

func NewApiListDowntimesOptionalParameters() *ApiListDowntimesOptionalParameters {
	this := ApiListDowntimesOptionalParameters{}
	return &this
}
func (r *ApiListDowntimesOptionalParameters) WithCurrentOnly(currentOnly bool) *ApiListDowntimesOptionalParameters {
 ...
 */
func (a *DowntimesApiService) ListDowntimes(ctx _context.Context, o ...ApiListDowntimesOptionalParameters) ([]Downtime, *_nethttp.Response, error) {
